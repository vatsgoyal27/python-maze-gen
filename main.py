import pygame
import grid
from mazemakers import MazeGeneratorDFS as dfs_gen, MazeGeneratorPrims as prims_gen, MazeGeneratorHuntAndKill as hak_gen, MazeGeneratorBinaryTree as btree_gen, MazeGeneratorOriginShift as ori_gen
